 ...
 * that it renders contains the passed in props. Let’s take a quick look at how this being done.
 * 
 *  The 'Route' component takes a prop called 'component' that represents the component 
 *  that will be rendered when a matching route is found. We want our 'childProps' to be sent to this component.
    ...
    and childProps prop. This allows us to pass in the component we want rendered 
    and the props that we want applied.

    Finally, we take component (set as C) and props (set as cProps) and render inside our Route 
    using the inline function; props => <C {...props} {...cProps} />. 
